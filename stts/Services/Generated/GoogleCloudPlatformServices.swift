...
final class GoogleAgentGateway: GoogleCloudPlatform, SubService {
    let name = "Google Agent Gateway"
    let dashboardName = "Agent Gateway"
}

final class GoogleAgentPlatformBatchInference: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Batch Inference"
    let dashboardName = "Agent Platform Batch Inference"
}

final class GoogleAgentPlatformFeatureStore: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Feature Store"
    let dashboardName = "Agent Platform Feature Store"
}

final class GoogleAgentPlatformManagedTraining: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Managed Training"
    let dashboardName = "Agent Platform Managed Training"
}

final class GoogleAgentPlatformMLMetadata: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform ML Metadata"
    let dashboardName = "Agent Platform ML Metadata"
}

final class GoogleAgentPlatformOnlineInference: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Online Inference"
    let dashboardName = "Agent Platform Online Inference"
}

final class GoogleAgentPlatformPipelines: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Pipelines"
    let dashboardName = "Agent Platform Pipelines"
}

final class GoogleAgentPlatformTensorBoard: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Tensor Board"
    let dashboardName = "Agent Platform Tensor Board"
}

final class GoogleAgentPlatformWorkbenchInstances: GoogleCloudPlatform, SubService {
    let name = "Google Agent Platform Workbench Instances"
    let dashboardName = "Agent Platform Workbench Instances"
}

final class GoogleAgentSearchOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Agent Search on Agent Platform"
    let dashboardName = "Agent Search on Agent Platform"
}

final class GoogleAICommerceSearch: GoogleCloudPlatform, SubService {
    let name = "Google AI Commerce Search"
    let dashboardName = "AI Commerce Search"
}
...
final class GoogleArtifactAnalysis: GoogleCloudPlatform, SubService {
    let name = "Google Artifact Analysis"
    let dashboardName = "Artifact Analysis"
}
...
final class GoogleAuditManager: GoogleCloudPlatform, SubService {
    let name = "Google Audit Manager"
    let dashboardName = "Audit Manager"
}
...
final class GoogleCloudHealthcare: GoogleCloudPlatform, SubService {
    let name = "Google Cloud Healthcare"
    let dashboardName = "Cloud Healthcare"
}
...
final class GoogleCloudNetworkInsights: GoogleCloudPlatform, SubService {
    let name = "Google Cloud Network Insights"
    let dashboardName = "Cloud Network Insights"
}
...
final class GoogleCustomerExperienceAgentStudio: GoogleCloudPlatform, SubService {
    let name = "Google Customer Experience Agent Studio"
    let dashboardName = "Customer Experience Agent Studio"
}
...
final class GoogleDatabaseCenter: GoogleCloudPlatform, SubService {
    let name = "Google Database Center"
    let dashboardName = "Database Center"
}
...
final class GoogleGeminiOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Gemini on Agent Platform"
    let dashboardName = "Gemini on Agent Platform"
}
...
final class GoogleImagenOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Imagen on Agent Platform"
    let dashboardName = "Imagen on Agent Platform"
}
...
final class GoogleModelMonitoringOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Model Monitoring on Agent Platform"
    let dashboardName = "Model Monitoring on Agent Platform"
}

final class GoogleModelRegistryOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Model Registry on Agent Platform"
    let dashboardName = "Model Registry on Agent Platform"
}
...
final class GooglePartnerCrossCloudInterconnect: GoogleCloudPlatform, SubService {
    let name = "Google Partner Cross-Cloud Interconnect"
    let dashboardName = "Partner Cross-Cloud Interconnect"
}
...
final class GoogleSecureSourceManager: GoogleCloudPlatform, SubService {
    let name = "Google Secure Source Manager"
    let dashboardName = "Secure Source Manager"
}
...
final class GoogleVeoOnAgentPlatform: GoogleCloudPlatform, SubService {
    let name = "Google Veo on Agent Platform"
    let dashboardName = "Veo on Agent Platform"
}
